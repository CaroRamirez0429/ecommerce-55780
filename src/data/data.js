const productos = [
  {
    ...
    descripcion: "La selección de un alimento adecuado para tu mascota es muy importante para garantizar su crecimiento, desarrollo y salud. Con esta opción de Excellent podrás cubrir las necesidades nutricionales y energéticas de tu perro. Se recomienda visitar a tu veterinario en caso de intoxicación o alergía",
    stock: 5,
    categoria: "mascotas",
  ...
  },
  {
    ...
    descripcion: "SOGA JUGUETE PARA PERROS 2 NUDOS PURO ALGODÓN 20 CM. Puro algodón, muy resistente y no daña a su perro. Favorece la limpieza e higiene de la dentadura de su mascota. Es caso de ingesta por accidente consulta a tu veterinario.",
    stock: 10,
    categoria: "mascotas",
